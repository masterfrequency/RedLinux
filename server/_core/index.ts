...
import { shadowProxyMiddleware } from "./ghostAuth";
...
async function startServer() {
  ...
  app.use(
    helmet({
      contentSecurityPolicy: false, // Disable CSP for easier development/integration
    }),
  );
  ...
  app.use("/artifacts", express.static(path.join(process.cwd(), "tmp")));
